...
exports.renderSidebarHtml = renderSidebarHtml;
exports.formatStatusLine = formatStatusLine;
exports.formatRuleStatus = formatRuleStatus;
...
function renderSidebarHtml(webview, snapshot, language, preferences) {
    const strings = i18n_1.STRINGS[language];
...
function renderScopeCard(scope, options) {
    const strings = i18n_1.STRINGS[options.language];
    const localMeta = i18n_1.STATUS_META[scope.status];
    const effectiveMeta = i18n_1.STATUS_META[options.effectiveStatus];
    ...
    <div class="grid">
      ...
      ${options.globalStatus ? `<div class="row">
        ...
        <div class="value">${escapeHtml(`${i18n_1.STATUS_META[options.globalStatus].icon} ${statusLabel(options.globalStatus, options.language)}`)}</div>
      </div>` : ''}
      <div class="row">
...
function formatStatusLine(status, language) {
    const meta = i18n_1.STATUS_META[status];
